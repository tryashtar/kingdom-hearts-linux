...
def check_openkh(openkh: OpenKh, symlinks: Symlinks, environment: Environment, settings: Settings, settings_path: pathlib.Path) -> dict[str, typing.Any]:
   ...
   if openkh.panacea is not None:
      ...
      for game in settings.games.get_classic():
         ...
         symlinks.make(folder / 'dependencies/avcodec-vgmstream-59.dll', openkh.folder / 'avcodec-vgmstream-59.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/avformat-vgmstream-59.dll', openkh.folder / 'avformat-vgmstream-59.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/avutil-vgmstream-57.dll', openkh.folder / 'avutil-vgmstream-57.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/bass.dll', openkh.folder / 'bass.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/bass_vgmstream.dll', openkh.folder / 'bass_vgmstream.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libatrac9.dll', openkh.folder / 'libatrac9.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libcelt-0061.dll', openkh.folder / 'libcelt-0061.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libcelt-0110.dll', openkh.folder / 'libcelt-0110.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libg719_decode.dll', openkh.folder / 'libg719_decode.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libmpg123-0.dll', openkh.folder / 'libmpg123-0.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libspeex-1.dll', openkh.folder / 'libspeex-1.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/libvorbis.dll', openkh.folder / 'libvorbis.dll', is_dir=False)
         symlinks.make(folder / 'dependencies/swresample-vgmstream-4.dll', openkh.folder / 'swresample-vgmstream-4.dll', is_dir=False)
